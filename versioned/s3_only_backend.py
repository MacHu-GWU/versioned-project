...
def encode_version(version: T.Optional[T.Union[int, str]]) -> str:
    ...
    used internally by the artifact management system. Strips leading zeros
    from numeric versions and handles None/LATEST special cases.
    
    :param version: Version number or string to normalize
